...
STORAGE_ACCOUNT="prdmgmtalzst" # must be globally unique, 3-24 chars, lowercase/numbers only
CONTAINER="tfstate"
SUBSCRIPTION_ID ="87d1b79f-82bc-4d1e-8c6e-b20bbde0f6d6" # Management Subscription ID 
ASSIGNEE_OBJECT_ID="5b9df515-4463-4fe5-92da-c324a1bb6534" # Object ID of the user or service principal to assign the role to
